...
const Header = () => {
  ...
  return (
    // <div className="grid lg md:grid-cols-3 sm:grid-cols-2 gap-4 m-5">
    //   <div className="">
    //     <img src="src/assets/icons/Logo.png" alt="Logo" />
    //   </div>
    //   <div className="lg md:flex hidden justify-evenly items-center bg-gray-900 border-2 border-stone-700 rounded-lg">
    ...
    //     </button>
    //   </div>
    //   <div className='flex lg md:hidden justify-end items-center'>
    //     <button className='hover:pointer-events-auto' onClick={() => console.log("idiota")}>
    //       <img className='h-10' src="src/assets/icons/menu.png" alt="menu" />
    //     </button>
    //   </div>
    // </div>
    <nav className='p-4'>
